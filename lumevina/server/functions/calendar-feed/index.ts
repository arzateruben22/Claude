// Lumevina — Supabase Edge Function: calendar-feed
//
...
Deno.serve(async (req) => {
  ...
  const lines: string[] = [
    "BEGIN:VCALENDAR", "VERSION:2.0", "PRODID:-//Lumevina//Owner//EN",
    "X-WR-CALNAME:Lumevina Appointments", "X-PUBLISHED-TTL:PT1H",
  ];
  for (const b of rows ?? []) {
    ...
    lines.push(
      ...
      `SUMMARY:${who}${svc}`,
      "LOCATION:Lumevina Aesthetics Spa",
      "END:VEVENT",
    );
  }
